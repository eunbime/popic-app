...
const NavBar = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full h-[50px]">
      <div className="max-w-[430px] mx-auto h-full flex justify-between items-center px-10 border-gray-200 bg-white dark:bg-gray-800 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] dark:shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.3)]">
